    ...
    <header className="relative z-40 bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 transition-colors shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 sm:h-22 flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className="h-16 sm:h-18 md:h-20 w-44 sm:w-56 md:w-64 flex items-center justify-start pt-1.5 pb-0.5 overflow-hidden">
              <img 
                src="/logo.png" 
                alt="Dua Trends Logo" 
                className="h-full w-full object-contain object-left scale-120 sm:scale-130 origin-left translate-y-1 transition-transform group-hover:scale-135"
                onError={(e) => {
